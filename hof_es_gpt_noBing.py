...
def search(query_text):
    ...
    #Change index name to match the name of the index you created when you setup the web crawler
...
st.title("NFL Hall of Fame GPT without Bing")
...
negResponse = "I'm unable to answer the question based on the information I have from NFL HoF Docs."
if submit_button:
    resp, url = search(query)
    prompt = f"Answer this question: {query}\nUsing only the information from this NFL HoF Doc: {resp}\nIf the answer is not contained in the supplied doc reply '{negResponse}' and nothing else"
